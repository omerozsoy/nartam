...
class YonetimController extends Controller
{
    ...
    private function muzayedeVeri(Request $request): array
    {
        $v = $request->validate([
            ...
            'baslangic_saat' => ['required', 'numeric', 'between:0,23'],
            'baslangic_dk' => ['required', 'numeric', 'between:0,59'],
            'bitis_tarih' => ['required', 'date_format:Y-m-d'],
            'bitis_saat' => ['required', 'numeric', 'between:0,23'],
            'bitis_dk' => ['required', 'numeric', 'between:0,59'],
